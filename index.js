...
import { get_buy_count, get_buy_count_onBlock } from './modules/get_buy_count.js';
...
async function test () {
    ...
    const token = '0x5a997925583dD37020cC3dCAa4E20228a9885541';
    const block = 17512762;
    const count = await get_buy_count_onBlock(block, token);
    console.log(count);
